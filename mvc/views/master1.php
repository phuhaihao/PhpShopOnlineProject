    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="amado-btn-group mt-30 mb-100">
                ...
                <a href="#" class="btn amado-btn active">Mới Trong Tuần</a>
            </div>
            <!-- Cart Menu -->
            <div class="cart-fav-search mb-100">
                <a href="cart.html" class="cart-nav"><img src="img/core-img/cart.png" alt=""> Giỏ Hàng <span>(0)</span></a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 col-xl-7">
                    <div class="newsletter-text mb-100">
                        <h2>Theo dõi chúng tôi để <span>giảm giá 25%</span></h2>
                        <p>Cửa hàng điện thoại NewPhone, chuyên bán các loại điện thoại và linh kiện điện thoại</p>
                    </div>
                </div>
                <!-- Newsletter Form -->
                <div class="col-12 col-lg-6 col-xl-5">
                    <div class="newsletter-form mb-100">
                        <form action="#" method="post">
                            ...
                            <input type="submit" value="Theo Dõi Shop">
                        </form>
                    </div>
                </div>
            </div>
